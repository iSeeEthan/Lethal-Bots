...
namespace LethalBots.Patches.ModPatches.LCAlwaysHearActiveWalkie
{
    public class LCAlwaysHearActiveWalkiePatch
    {
        /*public static IEnumerable<CodeInstruction> alwaysHearWalkieTalkiesPatch_Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            {
                Plugin.LogError($"LethalBot.Patches.ModPatches.LCAlwaysHearActiveWalkie.LCAlwaysHearActiveWalkiePatch.alwaysHearWalkieTalkiesPatch_Transpiler could not use irl number of player in list.");
            }
