...
namespace LethalBots.Patches.ModPatches.MoreEmotes
{
    ...
    public class MoreEmotesPatch
    {
        ...
        static IEnumerable<CodeInstruction> PerformEmotePrefix_Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            {
                Plugin.LogError($"LethalBot.Patches.ModPatches.MoreEmotesPatch.PerformEmotePrefix_Transpiler could not use irl number of player for iteration.");
            }
            ...
            {
                Plugin.LogError($"LethalBot.Patches.ModPatches.MoreEmotesPatch.PerformEmotePrefix_Transpiler could not bypass context performed for bots.");
            }
            ...
            {
                Plugin.LogError($"LethalBot.Patches.ModPatches.MoreEmotesPatch.PerformEmotePrefix_Transpiler could not bypass timeSinceStartingEmote for bots.");
            }
