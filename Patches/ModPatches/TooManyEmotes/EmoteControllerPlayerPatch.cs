...
namespace LethalBots.Patches.ModPatches.TooManyEmotes
{
    ...
    public class EmoteControllerPlayerPatch
    {
        ...
        public static IEnumerable<CodeInstruction> PerformEmote_Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            {
                Plugin.LogError($"LethalBot.Patches.ModPatches.TooManyEmotes.EmoteControllerPlayerPatch.PerformEmote_Transpiler could not not do OnStartCustomEmoteLocal when bot.");
            }
        ...
        public static IEnumerable<CodeInstruction> StopPerformingEmote_Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            {
                Plugin.LogError($"LethalBot.Patches.ModPatches.TooManyEmotes.EmoteControllerPlayerPatch.StopPerformingEmote_Transpiler could not not do OnStopCustomEmoteLocal when bot.");
            }
