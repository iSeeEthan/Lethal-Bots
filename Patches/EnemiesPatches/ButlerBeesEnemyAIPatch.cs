...
namespace LethalBots.Patches.EnemiesPatches
{
    ...
    {
        /// <summary>
        /// Patch onCollide to check for player and bots
        /// </summary>
        ...
        public static IEnumerable<CodeInstruction> OnCollideWithPlayer_Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            {
                Plugin.LogError($"LethalBot.Patches.EnemiesPatches.ButlerBeesEnemyAIPatch.OnCollideWithPlayer_Transpiler could not check if local player or bot owner local player");
            }
