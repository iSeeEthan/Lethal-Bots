...
namespace LethalBots.Patches.EnemiesPatches
{
    ...
    {
        /// <summary>
        /// Patch to make the spider use the right player id for hurting the player(bot) instead of only localPlayerController id.
        /// </summary>
        ...
        public static IEnumerable<CodeInstruction> OnCollideWithPlayer_Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            {
                Plugin.LogError($"LethalBot.Patches.EnemiesPatches.SandSpiderAIPatch.OnCollideWithPlayer_Transpiler could not change use of correct player id for HitPlayerServerRpc.");
            }
