...
namespace LethalBots.Patches.EnemiesPatches
{
    ...
    public class RedLocustBeesPatch
    {
        ...
        public static IEnumerable<CodeInstruction> OnCollideWithPlayer_Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            {
                Plugin.LogError($"LethalBot.Patches.EnemiesPatches.RedLocustBeesPatch.OnCollideWithPlayer_Transpiler could not call BeeKillPlayerOnLocalClient on player id.");
            }
            ...
            {
                Plugin.LogError($"LethalBot.Patches.EnemiesPatches.RedLocustBeesPatch.OnCollideWithPlayer_Transpiler could not call BeeKillPlayerServerRpc on player id.");
            }
            ...
            {
                Plugin.LogError($"LethalBot.Patches.EnemiesPatches.RedLocustBeesPatch.OnCollideWithPlayer_Transpiler could not call EnterAttackZapModeServerRpc player on player id.");
            }
